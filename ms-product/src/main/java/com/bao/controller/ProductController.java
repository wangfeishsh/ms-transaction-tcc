...
public class ProductController {
    ...
    public Response<Participant> frozen(@RequestBody FrozenRequest request) {
        ...
        Participant participant = Participant.builder().serverName("ms-product").serverUri("/v1/" + UUID.randomUUID() + "/confirm").expireTime(LocalDate.now().plus(30L, ChronoUnit.MINUTES)).build();
